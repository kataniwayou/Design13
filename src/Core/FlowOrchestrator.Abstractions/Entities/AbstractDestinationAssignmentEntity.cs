...
/// <summary>
/// Abstract base class for destination assignment entities.
/// </summary>
public abstract class AbstractDestinationAssignmentEntity : AbstractEntity, IVersionedEntity
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the destination parameters.
    /// </summary>
    public Dictionary<string, string> DestinationParameters { get; set; } = new Dictionary<string, string>();
    ...
    /// <summary>
    /// Creates a new instance of the AbstractDestinationAssignmentEntity class.
    /// </summary>
    protected AbstractDestinationAssignmentEntity() : base()
    {
    }
    
    /// <summary>
    /// Creates a new instance of the AbstractDestinationAssignmentEntity class with the specified ID, name, and description.
    /// </summary>
    ...
    protected AbstractDestinationAssignmentEntity(string id, string name, string description, string flowId, string destinationId) 
    ...
    /// <summary>
    /// Creates a new instance of the AbstractDestinationAssignmentEntity class with the specified ID, name, description, and version information.
    /// </summary>
    /// <param name="id">The unique identifier for the entity.</param>
    /// <param name="name">The name of the entity.</param>
    /// <param name="description">The description of the entity.</param>
    ...
    protected AbstractDestinationAssignmentEntity(
        string id, 
        string name, 
        string description, 
        string flowId,
    ...
    public override string GetEntityType() => "DestinationAssignmentEntity";
