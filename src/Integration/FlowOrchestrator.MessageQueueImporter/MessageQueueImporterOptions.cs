...
/// <summary>
/// Options for the message queue importer.
/// </summary>
public class MessageQueueImporterOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets a value indicating whether to acknowledge messages after processing.
    /// </summary>
    public bool AcknowledgeMessages { get; set; } = true;
    
    /// <summary>
    /// Gets or sets a value indicating whether to requeue messages on error.
    /// </summary>
    public bool RequeueOnError { get; set; } = false;
    
    /// <summary>
    /// Gets or sets a value indicating whether to send messages to the dead letter queue on error.
    /// </summary>
    public bool DeadLetterOnError { get; set; } = true;
