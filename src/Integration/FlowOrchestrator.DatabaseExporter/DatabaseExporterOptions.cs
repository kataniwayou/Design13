...
/// <summary>
/// Options for the database exporter.
/// </summary>
public class DatabaseExporterOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets a value indicating whether to keep identity values when using bulk operations.
    /// </summary>
    public bool KeepIdentity { get; set; } = false;
    
    /// <summary>
    /// Gets or sets a value indicating whether to check constraints when using bulk operations.
    /// </summary>
    public bool CheckConstraints { get; set; } = true;
    
    /// <summary>
    /// Gets or sets a value indicating whether to fire triggers when using bulk operations.
    /// </summary>
